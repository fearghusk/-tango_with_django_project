...
# Then we will create a dictionary of dictionaries for our categories. # This might seem a little bit confusing, but it allows us to iterate # through each data structure, and add the data to our models.
    python_pages = [
        ...
        'url':'http://docs.python.org/3/tutorial/','views':21}, {'title':'How to Think like a Computer Scientist',
        'url':'http://www.greenteapress.com/thinkpython/','views':19}, {'title':'Learn Python in 10 Minutes',
    ...
    django_pages = [
        ...
        {'title':'Django Rocks', 'url':'http://www.djangorocks.com/','views':912},
        {'title':'How to Tango with Django', 'url':'http://www.tangowithdjango.com/','views':200} ]
    other_pages = [
        {'title':'Bottle','url':'http://bottlepy.org/docs/dev/','views':36}, {'title':'Flask',
        'url':'http://flask.pocoo.org','views':356} ]
